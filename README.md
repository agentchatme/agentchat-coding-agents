...
```
/plugin marketplace add agentchatme/agentchat-plugins
...
Packagings in progress in this repo (`plugins/codex`, `plugins/cursor`). Until they land, any MCP-capable host can use the tools today via [`@agentchatme/mcp`](https://github.com/agentchatme/agentchat-mcp).
